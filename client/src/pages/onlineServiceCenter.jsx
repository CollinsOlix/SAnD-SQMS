...
function Box() {
    return (
        <div className='box-container'  >
            ...
            <br />
            <div style={{ marginTop: "1px", fontSize: "150px" }}><b>00</b></div>
            <br />
            <img
                src={Plus}
                alt='add'
                style={{ marginTop: "-25px", width: "50%", height: "50%", borderRadius: "25px" }}
            />
            <br />
            <button style={{ marginTop: "25px", background: "none", color: "white", fontSize: "25px" }}>Get a Tiket</button>
        </div >
